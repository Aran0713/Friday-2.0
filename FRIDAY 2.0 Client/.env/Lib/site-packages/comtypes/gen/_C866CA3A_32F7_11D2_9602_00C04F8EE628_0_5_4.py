...
__all__ = [
    'SVSFParseAutodetect', 'SpeechGrammarTagDictation',
    'DISPID_SRSClsidEngine', 'DISPID_SWFEAvgBytesPerSec', 'SDTRule',
    'SpeechTokenValueCLSID', 'SP_VISEME_3', 'SPPS_Function',
    'DISPID_SRCCmdMaxAlternates', 'SAFT32kHz8BitStereo',
    'SPPS_NotOverriden', 'SVSFUnusedFlags',
    'DISPID_SOTCreateInstance', 'SPXRO_Alternates_SML',
    'DISPID_SRRTStreamTime', 'SPSEMANTICFORMAT',
    'DISPID_SABIBufferSize', 'SpStream', 'DISPID_SRRAudio',
    'SPBO_TIME_UNITS', 'SPDKL_CurrentUser', 'SPEI_MIN_TTS',
    'DISPID_SPIStartTime', 'SPEI_MAX_TTS', '__MIDL_IWinTypes_0009',
    'SPAR_Unknown', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    ...
    'SPPROPERTYINFO', 'DISPID_SVIsUISupported', 'SVEVoiceChange',
    'SDTAudio', 'DISPID_SGRsItem', 'DISPID_SLPType',
    'DISPID_SGRsCommitAndSave', 'SPSSuppressWord',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechPhraseElement',
    'SREBookmark', 'SPAUDIOSTATE', 'ISpNotifySink',
    'DISPID_SVGetAudioInputs', 'DISPID_SRCEAdaptation', 'SLODynamic',
    'SAFTDefault', 'SRERequestUI', 'SpeechRetainedAudioOptions',
    'SPEI_SOUND_END', 'DISPID_SpeechAudio', 'SPVPRI_ALERT',
    'ISpeechObjectTokens', 'DISPID_SVResume',
    'DISPID_SPIEnginePrivateData', 'SPDATAKEYLOCATION',
    'SpeechCategoryVoices', 'DISPID_SOTCDefault', 'ISpRecoGrammar',
    'DISPID_SRRGetXMLResult', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRCEInterference', 'ISpRecoResult',
    ...
    'eLEXTYPE_PRIVATE16', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVAlertBoundary',
    'SPWORDTYPE', 'SRTEmulated', 'SpLexicon', 'DISPID_SRCPause',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SpMMAudioIn',
    'SpeechCategoryAudioOut', 'DISPID_SOTGetDescription',
    'ISpObjectToken', 'DISPID_SRCRetainedAudioFormat', 'SVSFIsNotXML',
    'SPGS_EXCLUSIVE', 'SPPHRASEREPLACEMENT', 'SPPS_Noun',
    'DISPID_SASetState', 'SVSFPersistXML', 'SITooSlow', 'SVEPrivate',
    'DISPID_SRCVoice', 'eLEXTYPE_VENDORLEXICON',
    'SGLexicalNoSpecialChars', 'SVEEndInputStream',
    'eLEXTYPE_RESERVED8', 'SREStreamStart', 'SDTPronunciation',
    'DISPID_SAStatus', 'DISPID_SpeechFileStream',
    'SpeechTokenKeyAttributes', 'SPEI_TTS_PRIVATE',
    'SPWORDPRONUNCIATIONLIST', 'SRAORetainAudio', 'DISPID_SAVolume',
    'ISpeechAudioBufferInfo', 'SpeechBookmarkOptions',
    'DISPID_SPISaveToMemory', 'SPADAPTATIONRELEVANCE',
    'ISpeechPhraseAlternate', 'SREHypothesis', 'SPCATEGORYTYPE',
    'SREInterference', 'SDKLCurrentConfig', 'DISPID_SFSOpen',
    'SGSExclusive', 'DISPID_SPRNumberOfElements',
    'SPINTERFERENCE_NOISE', 'DISPIDSPTSI_ActiveLength',
    ...
    'DISPID_SRCBookmark', 'DISPID_SLPsCount', 'DISPID_SOTSetId',
    'DISPID_SPRuleFirstElement', 'SpeechUserTraining', 'SPAR_High',
    'ISpeechMemoryStream', 'ISpAudio', 'SPRST_NUM_STATES', 'SBONone',
    'DISPID_SPACommit', 'ISpPhraseAlt', 'SVP_13',
    'DISPID_SRCCreateGrammar', 'eLEXTYPE_PRIVATE7',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEI_VISEME',
    'DISPID_SPEEngineConfidence', 'DISPID_SpeechDataKey', 'LONG_PTR',
    'SPPS_Interjection', 'DISPID_SRGetPropertyNumber',
    'SREPropertyStringChange', 'IInternetSecurityMgrSite',
    'SAFT12kHz16BitStereo', 'SVSFNLPMask', 'SVEWordBoundary',
    'ISpeechRecoResult', 'DISPID_SVEEnginePrivate',
    'SAFT24kHz16BitMono', 'SVF_Emphasis', 'DISPID_SGRs_NewEnum',
    'SPSHORTCUTTYPE', 'ISpSerializeState', 'SVSFIsFilename',
    'SPDKL_DefaultLocation', 'SPRST_INACTIVE_WITH_PURGE',
    'SPSHORTCUTPAIR', 'SPINTERFERENCE_TOOFAST', 'SDTAll',
    'DISPID_SLGetPronunciations', 'SPSUnknown', 'SAFT22kHz16BitMono',
    'SpeechRecognitionType', 'SpeechRunState',
    'SpeechVoiceCategoryTTSRate', 'SpeechLexiconType', 'SPRULESTATE',
    'DISPID_SRGRules', 'DISPID_SpeechObjectToken',
    'DISPID_SRGDictationUnload', 'DISPID_SLWs_NewEnum', 'SPSHT_OTHER',
    'STSF_CommonAppData', 'SP_VISEME_7', 'SGRSTTWord',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTNonStandardFormat', 'SPRECOSTATE', 'SpeechWordPronounceable',
    ...
    'SGRSTTDictation', 'SPEI_WORD_BOUNDARY', 'SPSVerb',
    'SpSharedRecognizer', 'SAFT44kHz16BitStereo', 'DISPIDSPTSI',
    'ISpRecognizer', 'SPRS_ACTIVE', 'SPSHT_EMAIL',
    'SpTextSelectionInformation', 'SpeechFormatType',
    'DISPID_SMSADeviceId', 'IStream', 'SPPS_SuppressWord',
    'DISPID_SGRAttributes', 'SVP_2', 'SpSharedRecoContext',
    'SPEI_SOUND_START', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPIEngineId', 'DISPID_SRCEAudioLevel',
    'DISPID_SPARecoResult', 'DISPID_SPRuleId', 'SpeechStreamFileMode',
    'DISPID_SADefaultFormat', 'SpStreamFormatConverter',
    'DISPID_SpeechLexiconProns', 'SPVISEMES', 'SPPHRASE',
    'Speech_Max_Pron_Length', 'SVP_7', 'SAFT32kHz8BitMono',
    'SAFT32kHz16BitMono', 'SAFTGSM610_44kHzMono', 'SPEI_RECOGNITION',
    'DISPID_SPAPhraseInfo', 'DISPID_SPEDisplayAttributes',
    'ISpDataKey', 'SDKLLocalMachine', 'DISPID_SPIRetainedSizeBytes',
    'SPPS_Modifier', 'SpWaveFormatEx', 'SFTInput',
    'DISPID_SPCIdToPhone', 'SpFileStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_13',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpNotifySource', 'SpeechAudioState',
    'ISpStream', 'DISPID_SOTCId', 'DISPID_SLWPronunciations',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SABufferNotifySize', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPRuleConfidence', 'SpeechCategoryRecoProfiles', 'SVP_5',
    'DISPID_SpeechRecoContext', 'DISPID_SPIReplacements',
    'DISPID_SPPEngineConfidence', 'SGDisplay', 'ISpRecoContext2',
    'SSSPTRelativeToEnd', 'SpMemoryStream', 'ISpGrammarBuilder',
    'eLEXTYPE_PRIVATE2', 'DISPID_SASCurrentSeekPosition',
    'SAFT11kHz8BitStereo', 'SAFT22kHz8BitStereo',
    'DISPID_SVEVoiceChange', 'SREAdaptation', 'SVSFPurgeBeforeSpeak',
    'SRESoundStart', 'SpeechPropertyResponseSpeed', 'DISPID_SGRName',
    'DISPID_SWFEExtraData', 'SINone', 'DISPID_SVGetAudioOutputs',
    'ISpeechGrammarRules', 'SWTDeleted',
    'DISPID_SRSCurrentStreamNumber', 'SVEAudioLevel', 'SRESoundEnd',
    'ISpMMSysAudio', 'DISPID_SPERequiredConfidence',
    'SAFTADPCM_11kHzStereo', 'ISpeechVoiceStatus',
    'SpNotifyTranslator', 'SPEI_RESERVED2', 'DISPID_SGRSTransitions',
    'SpResourceManager', 'SVP_0', 'SVP_17', 'DISPID_SRRTTickCount',
    'SECFIgnoreCase', 'SRARoot', 'STCInprocHandler',
    'DISPID_SRGRecoContext', 'SPEI_PHRASE_START',
    'ISpeechPhraseRules', 'SPPS_RESERVED2', 'DISPID_SFSClose',
    'DISPID_SPIGetText', 'SpeechAllElements', 'ISpeechMMSysAudio',
    'ISpeechRecoContext', 'SSFMOpenReadWrite', 'SAFTGSM610_8kHzMono',
    'DISPID_SGRInitialState', 'DISPID_SPIProperties',
    'DISPID_SMSALineId', 'DISPID_SVSkip', 'SAFTCCITT_ALaw_22kHzMono',
    'SASPause', 'DISPID_SpeechLexiconWord', 'SGDSInactive',
    'DISPID_SRProfile', 'SPGS_ENABLED', 'SpeechVoiceSkipTypeSentence',
    'DISPIDSPTSI_SelectionLength', 'SPEI_HYPOTHESIS', 'SP_VISEME_0',
    'ISpeechWaveFormatEx', 'SPSERIALIZEDRESULT',
    'DISPID_SpeechPhraseRule', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_PRIVATE5', 'SPXRO_SML', 'SpeechCategoryAppLexicons',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPRDisplayAttributes', 'DISPID_SABufferInfo',
    'SPEI_ADAPTATION', 'SVP_18', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SVSLastBookmark',
    'SVEPhoneme', 'SPPS_Unknown', 'DISPID_SpeechPhraseElements',
    'SVP_12', 'SSTTWildcard', 'ISpeechPhraseProperties',
    'SPPS_RESERVED1', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPLO_DYNAMIC', 'SVESentenceBoundary', 'DISPID_SOTRemove',
    'DISPID_SRIsShared', 'DISPID_SPAsCount', 'ISpeechGrammarRule',
    'SREStateChange', 'SVEStartInputStream', 'DISPID_SDKCreateKey',
    'DISPID_SWFEFormatTag', 'SITooLoud',
    'DISPID_SpeechRecoResultTimes', 'ISpLexicon', 'SECFIgnoreWidth',
    'DISPID_SPCPhoneToId', 'SpeechAddRemoveWord',
    'DISPID_SRCreateRecoContext', 'DISPID_SRRTimes',
    'DISPID_SDKSetBinaryValue', 'SPTEXTSELECTIONINFO',
    'DISPID_SRGCmdLoadFromResource', 'SPWT_PRONUNCIATION',
    'SAFTCCITT_ALaw_8kHzMono', 'SDTLexicalForm', 'ISpResourceManager',
    'SLTApp', 'SpeechTokenKeyUI', 'SRAONone',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechXMLRecoResult',
    'SRTExtendableParse', 'SPRULE', 'DISPID_SPCLangId',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SVEPhoneme', 'Speech_Default_Weight',
    'SPSERIALIZEDPHRASE', 'DISPID_SGRSTType', 'SpMMAudioOut',
    'DISPID_SLGenerationId', 'ISpVoice', 'SPRECORESULTTIMES',
    'SpVoice', 'SPWORDPRONUNCIATION', 'DISPID_SpeechVoice',
    'SP_VISEME_9', 'SpeechEngineConfidence', 'eLEXTYPE_MORPHOLOGY',
    'SAFT24kHz8BitStereo', 'DISPID_SGRAddResource',
    'eLEXTYPE_PRIVATE11', 'DISPID_SpeechRecognizerStatus',
    'SpeechPropertyNormalConfidenceThreshold', 'SPXMLRESULTOPTIONS',
    'SAFT24kHz16BitStereo', 'SITooFast',
    'SpeechPropertyResourceUsage', 'ISpeechLexiconWords', 'SWTAdded',
    'DISPID_SVVoice', 'SpeechTokenIdUserLexicon',
    ...
    'eLEXTYPE_PRIVATE18', 'SPEI_START_INPUT_STREAM', 'SVF_Stressed',
    'DISPID_SPAStartElementInResult', 'DISPID_SLPSymbolic',
    'SPAUDIOOPTIONS', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPRs_NewEnum', 'DISPID_SDKEnumKeys', 'SPPS_Noncontent',
    ...
    'SPFM_CREATE', 'eLEXTYPE_PRIVATE4', 'SPGRAMMARSTATE',
    'SpeechRegistryLocalMachineRoot', 'ISpeechRecoGrammar',
    'DISPID_SPRsCount', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SDKGetlongValue', 'ISpeechObjectToken', 'SSTTDictation',
    'SVP_3', 'DISPID_SpeechMMSysAudio',
    'DISPID_SpeechPhraseProperties', 'SPAR_Low',
    'SAFTADPCM_8kHzStereo', 'SINoise', 'SPSHT_Unknown',
    'DISPID_SPPsItem', 'DISPID_SRGCmdSetRuleState',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SVEAudioLevel', 'SPFILEMODE', 'DISPID_SLPPartOfSpeech',
    'DISPID_SOTs_NewEnum', 'DISPID_SGRSTPropertyValue',
    'SPWT_DISPLAY', 'SECFIgnoreKanaType', 'eLEXTYPE_RESERVED6',
    'DISPID_SRGetPropertyString', 'SAFT8kHz8BitStereo',
    'SPEI_RESERVED1', 'DISPID_SVSRunningState',
    'SpeechGrammarTagWildcard', 'DISPID_SMSSetData',
    'SpeechEmulationCompareFlags', 'SpMMAudioEnum',
    ...
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRAudioInput', 'SRTStandard',
    'SVP_1', 'SWPUnknownWordUnpronounceable', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVPriority', 'DISPID_SRCESoundEnd', 'SPLOADOPTIONS',
    'SPVPRI_NORMAL', 'SPVPRI_OVER', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechRecognizer', 'DISPID_SRCEBookmark',
    'SDKLDefaultLocation', 'ISpStreamFormatConverter',
    'IInternetSecurityManager', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRSetPropertyString', 'DISPID_SRGSetWordSequenceData',
    'SSFMCreateForWrite', 'SGRSTTRule', 'SPEI_END_SR_STREAM',
    'SpInprocRecognizer', 'DISPID_SLWsCount', 'SASStop',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPEsItem', 'SVSFParseMask',
    'DISPID_SpeechGrammarRule', '_ISpeechVoiceEvents',
    'DISPID_SGRSTPropertyId', 'SPCS_ENABLED', 'SSSPTRelativeToStart',
    'SPEI_SR_PRIVATE', 'DISPID_SLPPhoneIds', 'ISpStreamFormat',
    'ISpNotifyTranslator', 'eLEXTYPE_RESERVED9', 'DISPID_SBSFormat',
    'DISPID_SPEActualConfidence', 'SPLO_STATIC',
    'DISPID_SPRuleEngineConfidence', 'SRADynamic',
    'DISPID_SGRSTs_NewEnum', 'SPSLMA', 'DISPID_SABIMinNotification',
    'SpeechSpecialTransitionType', 'SVP_21', 'ISpPhrase',
    'DISPID_SRGReset', 'SVP_20', 'SpeechDiscardType',
    'DISPID_SpeechAudioFormat', 'DISPID_SPPs_NewEnum',
    'DISPID_SBSSeek', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRRAudioFormat', 'SLTUser', 'ISpRecognizer3',
    'SAFT12kHz8BitStereo', 'SVP_16', 'SECLowConfidence',
    'SAFT11kHz16BitMono', 'SPSModifier', 'DISPID_SpeechVoiceEvent',
    'SAFT16kHz16BitMono', 'DISPID_SPRuleParent', 'SPCONTEXTSTATE',
    'ISpeechPhraseProperty', 'DISPID_SLRemovePronunciation',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRRRecoContext',
    'SPEI_RESERVED3', 'DISPID_SRDisplayUI', 'DISPID_SpeechRecoResult',
    'SpShortcut', 'eLEXTYPE_PRIVATE17', 'SPBO_AHEAD',
    'DISPID_SRState', 'DISPID_SRIsUISupported', 'SP_VISEME_10',
    'SITooQuiet', 'SpPhraseInfoBuilder', 'WAVEFORMATEX', 'SRSEDone',
    'SRSActive', 'SPCS_DISABLED', 'SPEI_SENTENCE_BOUNDARY',
    ...
    'DISPID_SPRules_NewEnum', 'DISPID_SPPName', 'DISPID_SRGId',
    'SPEI_MAX_SR', 'SDA_Consume_Leading_Spaces',
    'Speech_StreamPos_Asap', 'SPFM_OPEN_READWRITE',
    'SPEI_INTERFERENCE', 'DISPID_SBSWrite', 'ISpeechAudioFormat',
    'SRCS_Disabled', 'DISPID_SpeechCustomStream',
    'DISPID_SRCEPhraseStart', 'DISPID_SPPParent', 'SASClosed',
    'SSFMOpenForRead', 'DISPID_SPERetainedStreamOffset',
    'SAFTCCITT_uLaw_8kHzMono', 'SPCT_SUB_COMMAND',
    'DISPID_SLAddPronunciationByPhoneIds', 'eLEXTYPE_PRIVATE12',
    'ISpEventSource', 'DISPID_SOTGetAttribute', 'SPPHRASEPROPERTY',
    'DISPID_SLAddPronunciation', 'DISPID_SpeechLexiconPronunciation',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTCCITT_uLaw_11kHzMono',
    'STCRemoteServer', 'SVP_6', 'DISPID_SVSVisemeId', 'SVP_14',
    'SAFT12kHz8BitMono', 'SPRS_INACTIVE',
    'DISPID_SPPNumberOfElements', 'DISPID_SVAudioOutput',
    'SP_VISEME_18', 'DISPID_SPIAudioSizeBytes', 'STSF_AppData',
    'SDTDisplayText', 'DISPID_SLGetGenerationChange',
    'ISpRecoCategory', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SpeechMemoryStream', 'SGDSActive',
    'ISpeechTextSelectionInformation', 'DISPID_SVEStreamStart',
    'SpeechPropertyLowConfidenceThreshold', 'SpObjectToken',
    'eLEXTYPE_APP', 'SREPropertyNumChange',
    'DISPID_SVSInputSentenceLength', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPEs_NewEnum', 'SREAllEvents', 'DISPID_SASState',
    'DISPID_SVEBookmark', '_RemotableHandle', 'ISpeechPhraseInfo',
    'DISPID_SBSRead', 'SAFT48kHz16BitStereo', 'DISPID_SGRClear',
    'SPPHRASERULE', 'SREFalseRecognition', 'SAFT8kHz16BitStereo',
    'SAFTCCITT_uLaw_22kHzStereo', 'SGRSTTEpsilon',
    'DISPID_SVSPhonemeId', 'eLEXTYPE_PRIVATE3',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPIAudioSizeTime',
    'SP_VISEME_8', 'SpeechRecoEvents', 'SDA_Two_Trailing_Spaces',
    'SPINTERFERENCE_NONE', 'SP_VISEME_5', 'SPWAVEFORMATTYPE',
    'SAFT16kHz8BitStereo', 'ISpeechAudio', 'SSTTTextBuffer',
    'ISpeechLexiconWord', 'SPAO_RETAIN_AUDIO', 'SAFT44kHz16BitMono',
    'DISPID_SGRSTsItem', 'DISPID_SRRTLength', 'SVP_15',
    'SPVOICESTATUS', 'SP_VISEME_1', 'eLEXTYPE_PRIVATE13', 'SPAS_RUN',
    'SpeechPropertyAdaptationOn', 'DISPID_SAFSetWaveFormatEx',
    'SAFTText', 'SWPUnknownWordPronounceable',
    'DISPID_SRRSaveToMemory', 'SPBO_NONE', 'SVSFNLPSpeakPunc',
    'IEnumSpObjectTokens', 'eWORDTYPE_DELETED',
    'DISPID_SABIEventBias', 'DISPID_SRRPhraseInfo',
    'SPSEMANTICERRORINFO', 'SPBO_PAUSE', 'DISPID_SVSpeak',
    'DISPID_SRCEPropertyNumberChange', 'SRSActiveAlways',
    'SAFT8kHz8BitMono', 'DISPID_SPILanguageId',
    'DISPID_SVSLastBookmarkId', 'SPEI_PHONEME',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SDKGetStringValue',
    'SVPOver', 'SpeechRuleAttributes', 'SPEVENT', 'SAFT8kHz16BitMono',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPELexicalForm',
    'SP_VISEME_20', 'DISPID_SPPConfidence', 'eLEXTYPE_PRIVATE19',
    'SpeechCategoryRecognizers', 'DISPID_SPRsItem', 'SPPS_LMA',
    'SPAS_PAUSE', 'ISpeechRecognizerStatus',
    'DISPID_SOTMatchesAttributes', 'SPAUDIOBUFFERINFO',
    'ISpeechPhraseAlternates', 'DISPID_SOTsItem',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SGRsDynamic', 'SPRST_ACTIVE',
    'SREPrivate', 'SAFT11kHz8BitMono', 'eLEXTYPE_PRIVATE10',
    'SPCT_SUB_DICTATION', 'DISPID_SpeechGrammarRuleState',
    'SpPhoneticAlphabetConverter', 'SECFEmulateResult',
    'SpeechLoadOption', 'SAFTADPCM_22kHzMono', 'SpeechMicTraining',
    'DISPID_SPERetainedSizeBytes', 'eLEXTYPE_PRIVATE15',
    'SAFT48kHz16BitMono', 'SPRECOGNIZERSTATUS', 'eLEXTYPE_PRIVATE14',
    'SPINTERFERENCE', 'SpeechStreamSeekPositionType', 'DISPID_SVRate',
    'SpeechGrammarState', 'DISPID_SpeechGrammarRules',
    'DISPID_SRAudioInputStream', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRAddState', 'DISPID_SPPId', 'ISpObjectWithToken',
    'DISPID_SPPChildren', 'DISPID_SPRuleName', 'SpeechTokenKeyFiles',
    'SAFTGSM610_22kHzMono', 'ISpeechPhraseReplacements',
    'eWORDTYPE_ADDED', 'SRTReSent', 'SPWF_INPUT', 'DISPID_SVVolume',
    'DISPID_SpeechAudioStatus', 'DISPID_SAEventHandle',
    'DISPID_SPRuleChildren', 'SVPAlert', 'SPFM_OPEN_READONLY',
    'SPEI_RESERVED6', 'SPGRAMMARWORDTYPE', 'SPVPRIORITY',
    'DISPID_SVESentenceBoundary', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPPsCount', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCCreateResultFromMemory', 'SAFT12kHz16BitMono',
    'SpeechAudioFormatType', 'SVP_9', 'DISPID_SRCEHypothesis',
    'SDA_One_Trailing_Space', 'ISpeechLexiconPronunciation',
    'tagSTATSTG', 'DISPID_SVEWord', 'DISPID_SpeechBaseStream',
    'DISPID_SAFGuid', 'DISPID_SRCState', 'SRCS_Enabled',
    'SGSDisabled', 'DISPID_SPIGrammarId', 'SPWORDLIST',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SOTDisplayUI',
    'SpObjectTokenCategory', 'SVSFParseSsml',
    'DISPID_SRGIsPronounceable', 'SINoSignal',
    'DISPID_SpeechPhraseReplacement',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT24kHz8BitMono', 'SP_VISEME_17', 'DISPID_SVEViseme',
    'ISpRecoContext', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SLWsItem', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRCRetainedAudio', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SWFEBlockAlign', 'SPEI_UNDEFINED', 'SP_VISEME_19',
    'DISPID_SVWaitUntilDone', 'DISPID_SRSAudioStatus',
    'SPSNotOverriden', 'SRAImport', 'SRTSMLTimeout',
    'SpeechRecognizerState', 'ISequentialStream',
    'SpeechGrammarWordType', 'SPEI_MIN_SR', 'SpeechVisemeType',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRSetPropertyNumber', '_SPAUDIOSTATE',
    'ISpeechRecoResult2', 'DISPID_SRCERequestUI', 'ISpeechBaseStream',
    'DISPID_SGRSRule', 'SRADefaultToActive', 'SSFMCreate',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SP_VISEME_2',
    'DISPID_SPAsItem', 'SpeechCategoryAudioIn',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRRecognizer',
    'SpeechVoiceEvents', 'DISPID_SRRGetXMLErrorInfo', 'ISpeechVoice',
    'SpInProcRecoContext', 'SPINTERFERENCE_TOOLOUD',
    'eLEXTYPE_PRIVATE8', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechLexiconWords', 'SAFT48kHz8BitMono',
    'SAFT22kHz16BitStereo', 'SRAExport',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPSHORTCUTPAIRLIST',
    'SGRSTTWildcard', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_RESERVED5', 'SRSInactiveWithPurge', 'DISPID_SLPLangId',
    'SGSEnabled', 'ISpeechGrammarRuleStateTransition',
    'SECFNoSpecialChars', 'DISPID_SMSAMMHandle', 'eLEXTYPE_RESERVED4',
    'DISPIDSPRG', 'SVSFVoiceMask', 'SAFT44kHz8BitMono', 'SPWORD',
    ...
    'DISPID_SDKEnumValues', 'DISPID_SGRsCount', 'SpeechInterference',
    'SDTAlternates', 'SVP_4', 'DISPID_SVGetVoices',
    ...
    'eLEXTYPE_RESERVED10', 'DISPID_SGRSTText', 'SVP_11',
    'DISPID_SpeechPhraseProperty', 'ISpeechPhraseInfoBuilder',
    'DISPID_SLWWord', 'SP_VISEME_4', 'eLEXTYPE_RESERVED7',
    'SPRST_ACTIVE_ALWAYS', 'SPAO_NONE', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SOTId', 'SPINTERFERENCE_TOOQUIET', 'DISPID_SLWType',
    'SVPNormal', 'SPRST_INACTIVE', 'STSF_FlagCreate',
    'DISPID_SRCESoundStart', 'SRTAutopause',
    'DISPID_SRSSupportedLanguages', 'Speech_Max_Word_Length',
    'SpeechPartOfSpeech', 'SPLEXICONTYPE', 'DISPID_SCSBaseStream',
    'SRATopLevel', 'DISPID_SRCEEnginePrivate', 'SLOStatic',
    'SREPhraseStart', 'SPPS_Verb', 'SPEI_VOICE_CHANGE',
    'SPFM_NUM_MODES', 'DISPID_SPPValue', 'SVSFDefault',
    'SpeechEngineProperties', 'SpeechAudioFormatGUIDWave',
    'STCLocalServer', 'ISpeechResourceLoader', 'DISPID_SVSLastResult',
    'ISpeechObjectTokenCategory', 'SpNullPhoneConverter',
    'ISpeechCustomStream', 'ISpXMLRecoResult', 'SPSFunction',
    'DISPID_SAFType', 'DISPID_SRGCommit', 'SRAInterpreter',
    'SpeechRecoProfileProperties', 'SAFT32kHz16BitStereo',
    'tagSPPROPERTYINFO', 'SRSInactive', 'ISpPhoneConverter',
    'SP_VISEME_21', 'SPSHT_NotOverriden', 'DISPID_SDKSetLongValue',
    'SPBINARYGRAMMAR', 'SVP_19', '_ISpeechRecoContextEvents',
    'DISPID_SLPsItem', 'SVEViseme', 'SPCT_DICTATION',
    'SpUnCompressedLexicon', 'SpeechAudioFormatGUIDText',
    'SPEI_END_INPUT_STREAM', 'DISPID_SGRSTWeight',
    'DISPID_SLPs_NewEnum', 'SECHighConfidence', 'SPBOOKMARKOPTIONS',
    'ISpEventSink', 'DISPID_SDKSetStringValue', 'ISpeechFileStream',
    'SAFTExtendedAudioFormat', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SGRsAdd', 'SRERecognition', 'DISPID_SOTCSetId',
    'SpeechWordType', 'SREStreamEnd', 'DISPID_SRCRequestedUIType',
    'SP_VISEME_16', 'DISPID_SPEDisplayText', 'SGLexical',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechTokenShellFolder',
    'SPEI_PROPERTY_STRING_CHANGE', 'STSF_LocalAppData',
    'DISPID_SOTDataKey', 'SPPS_RESERVED3', 'DISPID_SRGetRecognizers',
    'SPEI_REQUEST_UI', 'SPCT_SLEEP', 'SAFTADPCM_8kHzMono',
    'ISpPhoneticAlphabetConverter', 'SVSFParseSapi',
    'DISPID_SOTCGetDataKey', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SVSpeakStream', 'DISPID_SWFEChannels', 'SPWF_SRENGINE',
    'SPAS_STOP', 'UINT_PTR', 'SVEBookmark', 'SDKLCurrentUser',
    'DISPID_SRCEFalseRecognition', 'SPDKL_CurrentConfig',
    'DISPID_SWFESamplesPerSec', 'SpeechAudioProperties',
    'SAFT11kHz16BitStereo', 'SDTProperty', 'DISPID_SGRSTsCount',
    'SPWORDPRONOUNCEABLE', 'SpeechRecoContextState',
    'DISPID_SpeechPhraseInfo', 'SP_VISEME_14', 'DISPID_SOTCategory',
    'SAFT16kHz8BitMono', 'ISpeechAudioStatus', 'SPAUDIOSTATUS',
    'SpeechVisemeFeature', 'DISPID_SGRsCommit', 'SRERecoOtherContext',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRRSpeakAudio',
    'DISPID_SPIRule', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVP_10',
    'eLEXTYPE_PRIVATE20', 'STCInprocServer', 'DISPID_SDKOpenKey',
    ...
    'DISPID_SpeechPhraseRules', 'SpeechDataKeyLocation',
    'DISPID_SDKGetBinaryValue', 'DISPID_SOTsCount', 'SFTSREngine',
    'IEnumString', 'ISpObjectTokenCategory', 'DISPID_SVEStreamEnd',
    'SPCT_COMMAND', 'DISPID_SVEventInterests', 'SBOPause', 'STCAll',
    ...
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPAR_Medium',
    ...
    'SGRSTTTextBuffer', 'SAFT44kHz8BitStereo', 'SREAudioLevel',
    'SP_VISEME_12', 'SpCompressedLexicon', 'DISPID_SPEPronunciation',
    'DISPID_SPIAudioStreamPosition', 'SVSFIsXML', 'SpPhoneConverter',
    'DISPID_SRCEEndStream', 'DISPID_SRCSetAdaptationData',
    'SAFTGSM610_11kHzMono', 'SDTReplacement', 'SPEI_SR_BOOKMARK',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPRFirstElement',
    'SpeechRegistryUserRoot', 'ISpeechPhraseElements', 'SP_VISEME_11',
    'DISPID_SPPFirstElement', 'DISPID_SRStatus',
    'SpeechPropertyComplexResponseSpeed', 'ISpeechRecognizer',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SVPause',
    'SPSTREAMFORMATTYPE', 'SP_VISEME_15', 'ISpRecognizer2',
    'SpAudioFormat', 'SPFM_CREATE_ALWAYS', 'DISPID_SPRText',
    'SECFDefault', 'DISPID_SVStatus', 'SVP_8', 'SPPS_RESERVED4',
    'DISPID_SGRSTNextState', 'SASRun', 'DISPID_SLWLangId',
    'DISPID_SPEAudioStreamOffset', 'ISpeechDataKey',
    'SPEVENTSOURCEINFO', 'SAFTADPCM_11kHzMono', 'ISpRecoGrammar2',
    'DISPID_SGRSAddSpecialTransition', 'SGPronounciation',
    'DISPID_SRGetFormat', 'SPSNoun', 'DISPID_SpeechPhraseElement',
    'SPAS_CLOSED', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRCEStartStream', 'DISPID_SGRSTPropertyName',
    'Speech_StreamPos_RealTime', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPSInterjection', 'DISPID_SVSpeakCompleteEvent', 'SPEVENTENUM',
    'SAFT48kHz8BitStereo', 'SpeechVoicePriority', 'eLEXTYPE_USER',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SGRsFindRule',
    'DISPID_SGRSTRule', 'DISPID_SpeechObjectTokens',
    'SAFTADPCM_44kHzMono', 'SpCustomStream', 'DISPID_SGRId',
    'SGDSActiveUserDelimited', 'ISpShortcut', 'DISPID_SPIElements',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SVDisplayUI',
    'DISPID_SRCResume', 'SPPARTOFSPEECH', 'SAFT22kHz8BitMono',
    'SAFT16kHz16BitStereo', 'SpeechAudioVolume', 'DISPID_SMSGetData',
    'DISPID_SRGState', 'DISPID_SpeechRecoContextEvents',
    'SP_VISEME_6', 'SRSEIsSpeaking', 'DISPID_SPRulesCount',
    'ISpeechPhoneConverter'
]

_check_version('1.1.14', 1658032135.639891)
